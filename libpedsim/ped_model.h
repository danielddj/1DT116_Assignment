...
namespace Ped
{
	...
	public:
		// Sets everything up
		void setup(std::vector<Tagent *> agentsInScenario, std::vector<Twaypoint *> destinationsInScenario, Ped::TagentSoA::AgentSoA *AgentSoAScenario, IMPLEMENTATION implementation);
	...
	private:
		...
		Ped::TagentSoA::AgentSoA *agentSoA;
